# Module 3 — times and snags

See `facilitator-note.md` for what not to claim.

About 20 minutes: lesson (~7), CRISP rebuild + template-vs-model check in `module-3.html` (~8), homework (~5). Use any school-approved tool.
...
Optional debrief: one person reads a CRISP rebuild. One person names a task a template already handles. Stop.
